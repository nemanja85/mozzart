  ...
  >
    <div class="p-4">
      ...
      <div class="grid grid-cols-[1fr_auto_1fr] gap-4 items-center">
        <div class="text-right"><div class="text-white">Manchester United</div></div>
        <div class="flex items-center justify-center min-w-20">
          <div class="flex items-center gap-3">
            <span class="text-2xl text-emerald-500">2</span><span class="text-slate-500">-</span
            ><span class="text-2xl text-emerald-500">1</span>
          </div>
        </div>
        <div class="text-left"><div class="text-white">Liverpool</div></div>
      </div>
    </div>
  </div>
  <div
